...
public class Doctor {
    ...
    public Doctor(int id, String name, String surname, int cityId, int hospitalId, String specialization, String experience, String regalies, String phone, String patronymic) {
        this.id = id;
        this.name = name;
